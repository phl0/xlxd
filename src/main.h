...
#define DMRIDDB_PATH                    "/opt/xlxd/dmrid.dat"                   // local file path
...
#define YSFNODEDB_PATH                  "/opt/xlxd/ysfnode.dat"                 // local file path
...
#define TERMINALOPTIONS_PATH            "/opt/xlxd/xlxd.terminal"
